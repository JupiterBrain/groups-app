...
AppId={{9D81F5F4-3350-4C6C-A083-CB6427F7B915}
AppName={#MyAppName}
...
DefaultDirName={autopf}\groups-app
...
[Files]
Source: ".\build\windows\runner\Release\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs ignoreversion  ; Program Files
